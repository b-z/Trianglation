...
void CPolygonView::OnDraw(CDC* pDC)
{
    ...
    if (!pDoc->flagShowSelect) {
        if (pDoc->flagShowA) {
            ...
            drawPolygonPoint(pDC, pDoc->a, pDoc->scale, pDoc->translation, r.right, r.bottom, 0, 0, 0, 3);
        ...
        if (pDoc->flagShowB) {
            ...
            drawPolygonPoint(pDC, pDoc->b, pDoc->scale, pDoc->translation, r.right, r.bottom, 0, 0, 0, 3);
            if (pDoc->flagShowPointID)
