...
public:
    ...
    void test(int max_size, int type, std::string file) {
        ...
        ofstream fout(file);
        using std::cout;
        fout << "size" << "\t" << "result" << "\t" << "log2(size)" << "\t" << "log2(sqrt(result))" << "\t" << "count" << "\t" << "log2(sqrt(count))" << "\n";
        cout << "size" << "\t" << "result" << "\t" << "log2(size)" << "\t" << "log2(sqrt(result))" << "\t" << "count" << "\t" << "log2(sqrt(count))" << "\n";
        while (size < max_size) {
            generatePolygon(int(size), type);
            int count;
            double result = testCurrentPolygon(count);
            fout << int(size) << "\t" << result << "\t" << log2(int(size)) << "\t" << log2(sqrt(result)) << "\t" << count << "\t" << log2(sqrt(count)) << "\n";
            cout << int(size) << "\t" << result << "\t" << log2(int(size)) << "\t" << log2(sqrt(result)) << "\t" << count << "\t" << log2(sqrt(count)) << "\n";
            double scale = 1.1;
